...
class RETOUCH_PT_preset(RetouchPanelMixin, Panel):
    ...
    @staticmethod
    def _resolve_current_dir(preset_root: str, current_folder: str) -> str:
        return os.path.join(preset_root, current_folder) if current_folder else preset_root

    def _draw_breadcrumbs(self, layout, current_folder: str):
        row = layout.row()
    ...
    def _draw_browser(self, layout, current_folder: str, subfolders: list[str], preset_files: list[str]):
